...
function bubbleSort([...arr]) {
  for (let i = 0; i < arr.length - 1; i++) {
    ...
    for (let j = i; j < arr.length - 1 - i; j++) {
      ...
      const timeTwo = arr[j + 1].cookingTime + arr[j + 1].deliTime;
...
function selectionSort([...foods]) {
  for (let i = 0; i < foods.length; i++) {
    ...
    for (let j = i + 1; j < foods.length; j++) {
      ...
      const timeTwo = foods[minimumIndex].cookingTime + foods[minimumIndex].deliTime;
...
function insertionSort([...foods]) {
  for (let i = 0; i < foods.length; i++) {
    for (let j = i; j > 0 && (foods[j].cookingTime + foods[j].deliverTime) < (foods[j - 1].cookingTime + foods[j - 1].deliveryTime); j--) {
